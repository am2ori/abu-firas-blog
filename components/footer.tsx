        ...
        <footer className="border-t border-stone-200 py-8 mt-16 bg-white">
            <div className="container mx-auto px-4 text-center section-fade-in">
                <div className="mb-6 flex justify-center">
                    <img src="/logo.png" alt="شعار المدونة" className="h-16 w-auto opacity-80 grayscale hover:grayscale-0 transition-all duration-500" />
                </div>
                <p className="text-stone-500 text-sm mb-4">
                    © {new Date().getFullYear()} عبدالعظيم أبو فراس. جميع الحقوق محفوظة.
                </p>
